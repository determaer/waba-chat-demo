...
/**Chat 1 */
  ...
  {
    senderId:1, chatId: 1, type: "message.text", text: "Привет!", status: 'read', timestamp: '1727027959',
    actions: [
  ...
  },
  {
    ...
    status: 'read', timestamp: '1727027959',
    actions: [
      { action: 'edit', title: 'изменить', icon: 'https://placehold.jp/30/336633/ffffff/64x64.png?text=pin' },
      { action: 'delete', title: 'удалить' }]
  },
...
/**Chat 2 */
  {
    ...
    text: "Привет!", status: 'read', timestamp: '1727027759',
    actions: [
  ...
  { senderId:2,chatId: 2, type: "message.text", text: "Привет!", status: 'read', timestamp: '1727027969' },
  {
    ...
    text: "Привет!", status: 'read', timestamp: '1727029959',
  ...
  },
  {
    ...
    text: "Привет!", status: 'received', timestamp: '1727527159',
    actions: [{ action: 'edit', title: 'изменить' }, { action: 'delete', title: 'удалить' }]
  },
  {
    ...
    timestamp: '1726743559',status: 'read'
  },
/**Chat 3 */
  {
  ...
  { senderId:4,chatId: 3, type: "message.text", text: "Привет!", status: 'read', timestamp: '1727024059' },
